...
describe "User pages" do
	...
	describe "index" do
		...
		# 	FactoryGirl.create(:user, name: "jiangzhengdong", email: "jiangzhengdong@gmail.com")
		# 	FactoryGirl.create(:user, name: "jzd", email: "jzd@gmail.com")
		# 	visit users_path
		# end
	...
	describe 'signup' do
		...
		describe "with valid information" do
			...
			describe "after saving the user" do
				before { click_button submit }
				let(:user) { User.find_by(email:'xautjzd@gmail.com')}
